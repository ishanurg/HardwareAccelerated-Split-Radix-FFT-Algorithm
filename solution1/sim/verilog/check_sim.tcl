...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.sr_fft.autotvin_input_0.dat"
         "c.sr_fft.autotvin_input_1.dat"
         "c.sr_fft.autotvin_input_2.dat"
         "c.sr_fft.autotvin_input_3.dat"
         "c.sr_fft.autotvin_input_4.dat"
         "c.sr_fft.autotvin_input_5.dat"
         "c.sr_fft.autotvin_input_6.dat"
         "c.sr_fft.autotvin_input_7.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.sr_fft.autotvout_output_0.dat"
         "rtl.sr_fft.autotvout_output_1.dat"
         "rtl.sr_fft.autotvout_output_2.dat"
         "rtl.sr_fft.autotvout_output_3.dat"
         "rtl.sr_fft.autotvout_output_4.dat"
         "rtl.sr_fft.autotvout_output_5.dat"
         "rtl.sr_fft.autotvout_output_6.dat"
         "rtl.sr_fft.autotvout_output_7.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
