...
`define AUTOTB_DUT      sr_fft
`define AUTOTB_DUT_INST AESL_inst_sr_fft
`define AUTOTB_TOP      apatb_sr_fft_top
`define AUTOTB_LAT_RESULT_FILE "sr_fft.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "sr_fft.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_sr_fft_top
...
`define AUTOTB_TVIN_input_0_out_wrapc  "../tv/rtldatafile/rtl.sr_fft.autotvin_input_0.dat"
`define AUTOTB_TVIN_input_1_out_wrapc  "../tv/rtldatafile/rtl.sr_fft.autotvin_input_1.dat"
`define AUTOTB_TVIN_input_2_out_wrapc  "../tv/rtldatafile/rtl.sr_fft.autotvin_input_2.dat"
`define AUTOTB_TVIN_input_3_out_wrapc  "../tv/rtldatafile/rtl.sr_fft.autotvin_input_3.dat"
`define AUTOTB_TVIN_input_4_out_wrapc  "../tv/rtldatafile/rtl.sr_fft.autotvin_input_4.dat"
`define AUTOTB_TVIN_input_5_out_wrapc  "../tv/rtldatafile/rtl.sr_fft.autotvin_input_5.dat"
`define AUTOTB_TVIN_input_6_out_wrapc  "../tv/rtldatafile/rtl.sr_fft.autotvin_input_6.dat"
`define AUTOTB_TVIN_input_7_out_wrapc  "../tv/rtldatafile/rtl.sr_fft.autotvin_input_7.dat"
...
`define AUTOTB_TVOUT_output_0_out_wrapc  "../tv/rtldatafile/rtl.sr_fft.autotvout_output_0.dat"
`define AUTOTB_TVOUT_output_1_out_wrapc  "../tv/rtldatafile/rtl.sr_fft.autotvout_output_1.dat"
`define AUTOTB_TVOUT_output_2_out_wrapc  "../tv/rtldatafile/rtl.sr_fft.autotvout_output_2.dat"
`define AUTOTB_TVOUT_output_3_out_wrapc  "../tv/rtldatafile/rtl.sr_fft.autotvout_output_3.dat"
`define AUTOTB_TVOUT_output_4_out_wrapc  "../tv/rtldatafile/rtl.sr_fft.autotvout_output_4.dat"
`define AUTOTB_TVOUT_output_5_out_wrapc  "../tv/rtldatafile/rtl.sr_fft.autotvout_output_5.dat"
`define AUTOTB_TVOUT_output_6_out_wrapc  "../tv/rtldatafile/rtl.sr_fft.autotvout_output_6.dat"
`define AUTOTB_TVOUT_output_7_out_wrapc  "../tv/rtldatafile/rtl.sr_fft.autotvout_output_7.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 627;
...
initial begin : dump_tvout_runtime_sign_output_0
    ...
    fp = $fopen(`AUTOTB_TVOUT_output_0_out_wrapc, "wb");
    if (fp == 0) begin
    ...
    fp = $fopen(`AUTOTB_TVOUT_output_0_out_wrapc, "ab");
    if (fp == 0) begin
        $display("Failed to open file \"%s\"!", `AUTOTB_TVOUT_output_0_out_wrapc);
        $display("ERROR: Simulation using HLS TB failed.");
        $finish;
...
initial begin : dump_tvout_runtime_sign_output_1
    ...
    fp = $fopen(`AUTOTB_TVOUT_output_1_out_wrapc, "wb");
    if (fp == 0) begin
    ...
    wait (done_cnt == AUTOTB_TRANSACTION_NUM);
    repeat(5) @ (posedge AESL_clock);
    fp = $fopen(`AUTOTB_TVOUT_output_1_out_wrapc, "ab");
    if (fp == 0) begin
        $display("Failed to open file \"%s\"!", `AUTOTB_TVOUT_output_1_out_wrapc);
        $display("ERROR: Simulation using HLS TB failed.");
        $finish;
...
initial begin : dump_tvout_runtime_sign_output_2
    ...
    fp = $fopen(`AUTOTB_TVOUT_output_2_out_wrapc, "wb");
    if (fp == 0) begin
    ...
    wait (done_cnt == AUTOTB_TRANSACTION_NUM);
    repeat(5) @ (posedge AESL_clock);
    fp = $fopen(`AUTOTB_TVOUT_output_2_out_wrapc, "ab");
    if (fp == 0) begin
        $display("Failed to open file \"%s\"!", `AUTOTB_TVOUT_output_2_out_wrapc);
        $display("ERROR: Simulation using HLS TB failed.");
        $finish;
...
initial begin : dump_tvout_runtime_sign_output_3
    ...
    fp = $fopen(`AUTOTB_TVOUT_output_3_out_wrapc, "wb");
    if (fp == 0) begin
    ...
    wait (done_cnt == AUTOTB_TRANSACTION_NUM);
    repeat(5) @ (posedge AESL_clock);
    fp = $fopen(`AUTOTB_TVOUT_output_3_out_wrapc, "ab");
    if (fp == 0) begin
        $display("Failed to open file \"%s\"!", `AUTOTB_TVOUT_output_3_out_wrapc);
        $display("ERROR: Simulation using HLS TB failed.");
        $finish;
...
initial begin : dump_tvout_runtime_sign_output_4
    ...
    fp = $fopen(`AUTOTB_TVOUT_output_4_out_wrapc, "wb");
    if (fp == 0) begin
    ...
    wait (done_cnt == AUTOTB_TRANSACTION_NUM);
    repeat(5) @ (posedge AESL_clock);
    fp = $fopen(`AUTOTB_TVOUT_output_4_out_wrapc, "ab");
    if (fp == 0) begin
        $display("Failed to open file \"%s\"!", `AUTOTB_TVOUT_output_4_out_wrapc);
        $display("ERROR: Simulation using HLS TB failed.");
        $finish;
...
initial begin : dump_tvout_runtime_sign_output_5
    ...
    fp = $fopen(`AUTOTB_TVOUT_output_5_out_wrapc, "wb");
    if (fp == 0) begin
    ...
    wait (done_cnt == AUTOTB_TRANSACTION_NUM);
    repeat(5) @ (posedge AESL_clock);
    fp = $fopen(`AUTOTB_TVOUT_output_5_out_wrapc, "ab");
    if (fp == 0) begin
        $display("Failed to open file \"%s\"!", `AUTOTB_TVOUT_output_5_out_wrapc);
        $display("ERROR: Simulation using HLS TB failed.");
        $finish;
...
initial begin : dump_tvout_runtime_sign_output_6
    ...
    fp = $fopen(`AUTOTB_TVOUT_output_6_out_wrapc, "wb");
    if (fp == 0) begin
    ...
    wait (done_cnt == AUTOTB_TRANSACTION_NUM);
    repeat(5) @ (posedge AESL_clock);
    fp = $fopen(`AUTOTB_TVOUT_output_6_out_wrapc, "ab");
    if (fp == 0) begin
        $display("Failed to open file \"%s\"!", `AUTOTB_TVOUT_output_6_out_wrapc);
        $display("ERROR: Simulation using HLS TB failed.");
        $finish;
...
initial begin : dump_tvout_runtime_sign_output_7
    ...
    fp = $fopen(`AUTOTB_TVOUT_output_7_out_wrapc, "wb");
    if (fp == 0) begin
    ...
    wait (done_cnt == AUTOTB_TRANSACTION_NUM);
    repeat(5) @ (posedge AESL_clock);
    fp = $fopen(`AUTOTB_TVOUT_output_7_out_wrapc, "ab");
    if (fp == 0) begin
        $display("Failed to open file \"%s\"!", `AUTOTB_TVOUT_output_7_out_wrapc);
        $display("ERROR: Simulation using HLS TB failed.");
        $finish;
